...
async function getData() {
  ...
  const pdp = {
    name: "Copo Térmico Stanley Everyday 296ml Branco",
    image: {
      url: "/assets/stanley-erveryday.png",
  ...
  const customer = {
    zipcode: "99999-999",
    city: "CITY",
    address: "R. ANY WHERE, 438, ANY NEIBORHOOD, COMPLEMENTS - CITY - STATE",
    loyalty: { points: "5.080", cashback: "R$ 252,000" },
  };

  const offer = {
    seller: "Top Store",
    price: "R$ 185,00",
    installments: { times: "12x", value: "R$ 15,42" },
    shipping: {
      value: "R$ 15,18",
      date: "quarta-feira 8 de maio",
    },
  };
